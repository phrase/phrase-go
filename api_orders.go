...
func (a *OrdersApiService) OrderConfirm(ctx _context.Context, projectId string, id string, orderConfirmParameters OrderConfirmParameters, localVarOptionals *OrderConfirmOpts) (TranslationOrder, *APIResponse, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/orders/{id}/confirm"
...
func (a *OrdersApiService) OrderCreate(ctx _context.Context, projectId string, orderCreateParameters OrderCreateParameters, localVarOptionals *OrderCreateOpts) (TranslationOrder, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/orders"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)
...
func (a *OrdersApiService) OrderDelete(ctx _context.Context, projectId string, id string, localVarOptionals *OrderDeleteOpts) ([]byte, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/orders/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)
...
type OrdersListOpts struct {
	...
	Branch        optional.String `json:"branch,omitempty"`
	TranslationId optional.String `json:"translation_id,omitempty"`
}
...
List all orders for the given project.
  ...
  - @param "Branch" (optional.String) -  specify the branch to use
  - @param "TranslationId" (optional.String) -  Filter the result to orders that include the given translation. When supplied with a translation code that does not exist, an empty list is returned.
...
func (a *OrdersApiService) OrdersList(ctx _context.Context, projectId string, localVarOptionals *OrdersListOpts) ([]TranslationOrder, *APIResponse, error) {
	...
	if localVarOptionals != nil && localVarOptionals.TranslationId.IsSet() {
		localVarQueryParams.Add("translation_id", parameterToString(localVarOptionals.TranslationId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
