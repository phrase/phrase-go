...
type TagsListOpts struct {
	...
	ExcludeSystemTags optional.Bool   `json:"exclude_system_tags,omitempty"`
	OnlySystemTags    optional.Bool   `json:"only_system_tags,omitempty"`
	Branch            optional.String `json:"branch,omitempty"`
...
List all tags for the given project.
  ...
  - @param "ExcludeSystemTags" (optional.Bool) -  Excludes tags generated by the system, e.g. job, upload or figma tags. Mutually exclusive with `only_system_tags`.
  - @param "OnlySystemTags" (optional.Bool) -  Returns only system-generated tags (e.g. job, upload, figma) and excludes user-defined tags. Mutually exclusive with `exclude_system_tags`.
  - @param "Branch" (optional.String) -  specify the branch to use
  - @param "Q" (optional.String) -  Specify a query to filter tags by name.
...
func (a *TagsApiService) TagsList(ctx _context.Context, projectId string, localVarOptionals *TagsListOpts) ([]Tag, *APIResponse, error) {
	...
	if localVarOptionals != nil && localVarOptionals.ExcludeSystemTags.IsSet() {
		localVarQueryParams.Add("exclude_system_tags", parameterToString(localVarOptionals.ExcludeSystemTags.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.OnlySystemTags.IsSet() {
		localVarQueryParams.Add("only_system_tags", parameterToString(localVarOptionals.OnlySystemTags.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Branch.IsSet() {
		localVarQueryParams.Add("branch", parameterToString(localVarOptionals.Branch.Value(), ""))
	}
