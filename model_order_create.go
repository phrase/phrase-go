...
type OrderCreate struct {
	...
	UnverifyTranslationsUponDelivery string `json:"unverify_translations_upon_delivery,omitempty"`
	// Order translations for keys with untranslated content in the selected target locales.
	IncludeUntranslatedKeys string `json:"include_untranslated_keys,omitempty"`
