...
*/
func (a *RepoSyncsApiService) RepoSyncEventShow(ctx _context.Context, accountId string, repoSyncId string, id string, localVarOptionals *RepoSyncEventShowOpts) (RepoSyncEvent, *APIResponse, error) {
	var (
...
/*
RepoSyncEvents Repository Syncs History
