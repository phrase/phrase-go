...
Download a locale in a specific file format.
  ...
  - @param "FilterByPrefix" (optional.Bool) -  Only download translation keys containing the prefix specified by `translation_key_prefix`, and remove that prefix from the generated file. Requires `translation_key_prefix` to be set.
