...
**TranslationKeysUnmentioned** | **int32** | The number of translation keys in the project that were not mentioned in the upload.  Note: this field is not calculated (and shows 0) if the upload contains more than 100,000 keys.  | [optional] 
