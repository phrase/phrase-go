...
**DefaultLocaleCodes** | **[]string** | List of default locales for the user, applied across all of the user&#39;s projects. This is the account-level field corresponding to \&quot;Language access\&quot; in the translator profile UI. | [optional] 
