...
**TargetAudience** | **string** | Target audience for the translations. | [optional] 
**GrammaticalPerson** | **string** | Preferred grammatical person. | [optional] 
**VocabularyType** | **string** | Vocabulary register the translations should use. | [optional] 
