...
**excludeSystemTags** | **optional.Bool**| Excludes tags generated by the system, e.g. job, upload or figma tags. Mutually exclusive with &#x60;only_system_tags&#x60;. | 
**onlySystemTags** | **optional.Bool**| Returns only system-generated tags (e.g. job, upload, figma) and excludes user-defined tags. Mutually exclusive with &#x60;exclude_system_tags&#x60;. | 
**branch** | **optional.String**| specify the branch to use | 
**q** | **optional.String**| Specify a query to filter tags by name. | 
