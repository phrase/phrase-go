...
func (a *WebhookDeliveriesApiService) WebhookDeliveriesList(ctx _context.Context, projectId string, webhookId string, localVarOptionals *WebhookDeliveriesListOpts) ([]WebhookDelivery, *APIResponse, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/webhooks/{webhook_id}/deliveries"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)

	localVarPath = strings.Replace(localVarPath, "{"+"webhook_id"+"}", _neturl.QueryEscape(parameterToString(webhookId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	if localVarOptionals != nil && localVarOptionals.ResponseStatusCodes.IsSet() {
		localVarQueryParams.Add("response_status_codes", parameterToString(localVarOptionals.ResponseStatusCodes.Value(), ""))
	}
...
func (a *WebhookDeliveriesApiService) WebhookDeliveriesRedeliver(ctx _context.Context, projectId string, webhookId string, id string, localVarOptionals *WebhookDeliveriesRedeliverOpts) (WebhookDelivery, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/webhooks/{webhook_id}/deliveries/{id}/redeliver"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)
...
func (a *WebhookDeliveriesApiService) WebhookDeliveriesShow(ctx _context.Context, projectId string, webhookId string, id string, localVarOptionals *WebhookDeliveriesShowOpts) (WebhookDelivery, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/webhooks/{webhook_id}/deliveries/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)
