...
func (a *MembersApiService) MemberDelete(ctx _context.Context, accountId string, id string, localVarOptionals *MemberDeleteOpts) ([]byte, *APIResponse, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/accounts/{account_id}/members/{id}"
...
func (a *MembersApiService) MemberUpdateSettings(ctx _context.Context, projectId string, id string, memberUpdateSettingsParameters MemberUpdateSettingsParameters, localVarOptionals *MemberUpdateSettingsOpts) (MemberProjectDetail, *APIResponse, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MemberProjectDetail
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/members/{id}"
	...
	// body params
	localVarPostBody = &memberUpdateSettingsParameters
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
// MembersByProjectOpts Optional parameters for the method 'MembersByProject'
type MembersByProjectOpts struct {
	XPhraseAppOTP optional.String `json:"X-PhraseApp-OTP,omitempty"`
	Q             optional.String `json:"q,omitempty"`
	JobId         optional.String `json:"job_id,omitempty"`
	Page          optional.Int32  `json:"page,omitempty"`
	PerPage       optional.Int32  `json:"per_page,omitempty"`
}

/*
MembersByProject List project members
Get all members active in the project. Access token scope must include &#x60;read&#x60;.
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param projectId Project ID
  - @param optional nil or *MembersByProjectOpts - Optional Parameters:
  - @param "XPhraseAppOTP" (optional.String) -  Two-Factor-Authentication token (optional)
  - @param "Q" (optional.String) -  Specify a query to search for members by name or email (including wildcards).
  - @param "JobId" (optional.String) -  Filter members to those assigned to the job identified by this id.
  - @param "Page" (optional.Int32) -  Page number
  - @param "PerPage" (optional.Int32) -  Limit on the number of objects to be returned, between 1 and 100. 25 by default

@return []ProjectMember
*/
func (a *MembersApiService) MembersByProject(ctx _context.Context, projectId string, localVarOptionals *MembersByProjectOpts) ([]ProjectMember, *APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *MembersApiService) MembersList(ctx _context.Context, accountId string, localVarOptionals *MembersListOpts) ([]Member, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/accounts/{account_id}/members"
	localVarPath = strings.Replace(localVarPath, "{"+"account_id"+"}", _neturl.QueryEscape(parameterToString(accountId, "")), -1)
