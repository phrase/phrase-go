...
// SupportedLanguagesApiService SupportedLanguagesApi service
type SupportedLanguagesApiService service

/*
LanguagesList List supported languages
...
*/
func (a *SupportedLanguagesApiService) LanguagesList(ctx _context.Context) (map[string]string, *APIResponse, error) {
	var (
