...
/*
KeysExclude Exclude a locale on a collection of keys
...
func (a *KeysApiService) KeysExclude(ctx _context.Context, projectId string, keysExcludeParameters KeysExcludeParameters, localVarOptionals *KeysExcludeOpts) (AffectedResources, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/keys/exclude"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)
	...
	// body params
	localVarPostBody = &keysExcludeParameters
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
KeysInclude Include a locale on a collection of keys
...
func (a *KeysApiService) KeysInclude(ctx _context.Context, projectId string, keysIncludeParameters KeysIncludeParameters, localVarOptionals *KeysIncludeOpts) (AffectedResources, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/keys/include"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", _neturl.QueryEscape(parameterToString(projectId, "")), -1)
	...
	// body params
	localVarPostBody = &keysIncludeParameters
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
KeysTag Add tags to collection of keys
...
/*
KeysUntag Remove tags from collection of keys
