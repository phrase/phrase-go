...
@return []Document
*/
func (a *DocumentsApiService) DocumentsList(ctx _context.Context, localVarOptionals *DocumentsListOpts) ([]Document, *APIResponse, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/documents"
